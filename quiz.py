...
def loginPage(logdata):
    ...
    login_canvas = Canvas(login,width=720,height=440,bg="orange")
    login_canvas.pack()
    ...
    log.configure(width = 15,height=1, activebackground = "#FFA500", relief = FLAT)
...
def signUpPage():
    ...
    sup_canvas = Canvas(sup,width=720,height=440,bg="orange")
    sup_canvas.pack()

    sup_frame = Frame(sup_canvas,bg="white")
    sup_frame.place(relwidth=0.8,relheight=0.8,relx=0.1,rely=0.1)

    heading = Label(sup_frame,text="Quiz App SignUp",fg="white",bg="#101357")
    heading.config(font=('Broadway 30'))
    heading.place(relx=0.2,rely=0.1)
    ...
    #KID
    clabel = Label(sup_frame,text="KID",fg='black',bg='white')
    clabel.place(relx=0.215,rely=0.7)
    c = Entry(sup_frame,bg='#d3d3d3',fg='black',textvariable = KID)
    c.config(width=42)
    ...
    def addUserToDataBase():
        ...
        create = conn.cursor()
        create.execute('CREATE TABLE IF NOT EXISTS userSignUp(FULLNAME text, USERNAME text,PASSWORD text,KID numeric)')
        create.execute("INSERT INTO userSignUp VALUES (?,?,?,?)",(fullname,username,password,KID)) 
        conn.commit()
...
def menu():
    ...
    wel = Label(menu_canvas,text=' T E C H Q U I Z  ',fg="white",bg="#101357") 
    wel.config(font=('Broadway 22'))
    wel.place(relx=0.1,rely=0.02)
    
    
    level = Label(menu_frame,text='Select your Difficulty Level !!',bg="white",font="calibri 20")
    level.place(relx=0.25,rely=0.3)
    
    
    var = IntVar()
    easyR = Radiobutton(menu_frame,text='Easy',bg="white",font="calibri 18",value=1,variable = var)
    easyR.place(relx=0.25,rely=0.4)
    
    mediumR = Radiobutton(menu_frame,text='Medium',bg="white",font="calibri 18",value=2,variable = var)
    mediumR.place(relx=0.25,rely=0.5)
    
    hardR = Radiobutton(menu_frame,text='Hard',bg="white",font="calibri 18",value=3,variable = var)
    ...
    def navigate():
        ...
        if x == 1:
            ...
            pass
    letsgo = Button(menu_frame,text="Let's Go",bg="green",font="calibri 16",command=navigate)
...
def easy():
    ...
    easy_canvas = Canvas(e,width=720,height=440,bg="#006400")
    easy_canvas.pack()
    ...
    a = Radiobutton(easy_frame,text=easyQ[x][1],font="calibri 14",value=easyQ[x][1],variable = var,bg="white")
    a.place(relx=0.5,rely=0.42,anchor=CENTER)

    b = Radiobutton(easy_frame,text=easyQ[x][2],font="calibri 14",value=easyQ[x][2],variable = var,bg="white")
    b.place(relx=0.5,rely=0.52,anchor=CENTER)

    c = Radiobutton(easy_frame,text=easyQ[x][3],font="calibri 14",value=easyQ[x][3],variable = var,bg="white")
    c.place(relx=0.5,rely=0.62,anchor=CENTER) 

    d = Radiobutton(easy_frame,text=easyQ[x][4],font="calibri 14",value=easyQ[x][4],variable = var,bg="white")
...
def medium():
    ...
    a = Radiobutton(med_frame,text=mediumQ[x][1],font="calibri 14",value=mediumQ[x][1],variable = var,bg="white")
    a.place(relx=0.5,rely=0.42,anchor=CENTER)

    b = Radiobutton(med_frame,text=mediumQ[x][2],font="calibri 14",value=mediumQ[x][2],variable = var,bg="white")
    b.place(relx=0.5,rely=0.52,anchor=CENTER)

    c = Radiobutton(med_frame,text=mediumQ[x][3],font="calibri 14",value=mediumQ[x][3],variable = var,bg="white")
    c.place(relx=0.5,rely=0.62,anchor=CENTER) 

    d = Radiobutton(med_frame,text=mediumQ[x][4],font="calibri 14",value=mediumQ[x][4],variable = var,bg="white")
    d.place(relx=0.5,rely=0.72,anchor=CENTER) 
...
def difficult():
    ...
    hard_canvas = Canvas(h,width=720,height=440,bg="#800000")
    hard_canvas.pack()
    ...
    a = Radiobutton(hard_frame,text=hardQ[x][1],font="calibri 14",value=hardQ[x][1],variable = var,bg="white")
    a.place(relx=0.5,rely=0.42,anchor=CENTER)

    b = Radiobutton(hard_frame,text=hardQ[x][2],font="calibri 14",value=hardQ[x][2],variable = var,bg="white")
    b.place(relx=0.5,rely=0.52,anchor=CENTER)

    c = Radiobutton(hard_frame,text=hardQ[x][3],font="calibri 14",value=hardQ[x][3],variable = var,bg="white")
    c.place(relx=0.5,rely=0.62,anchor=CENTER) 

    d = Radiobutton(hard_frame,text=hardQ[x][4],font="calibri 14",value=hardQ[x][4],variable = var,bg="white")
    d.place(relx=0.5,rely=0.72,anchor=CENTER) 
...
def showMark(mark):
    ...
    mlabel = Label(show_canvas,text=st,fg="black",font="calibri 14")
...
def start():
    global root 
    root = Tk()
    canvas = Canvas(root,width = 420,height = 400)
    canvas.grid(column = 0 , row = 1)
    img = PhotoImage(file="C:\\Users\\anant\\OneDrive\\Desktop\\Projects\\Quiz\\Quiz\\Cpu.png")
    canvas.create_image(50,10,image=img,anchor=NW)

    button = Button(root, text='Start',command = signUpPage) 
    button.configure(width = 102,height=2, activebackground = "#33B5E5", bg ='orange', relief = RAISED)
